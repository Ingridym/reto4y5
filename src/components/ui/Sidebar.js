...
const Sidebar = () => {
       return( 
        <div className="md:w-2/6 xl:w-1/5 bg-gray-800">
            <div className="p-6">
                <p className="uppercase text-white text-2xl tracking-wide text-center font-bold">Cenicienta LTDA</p>

                <p className="mt-3 text-gray-600">Administra tus pedidos en las siguientes opciones:</p>
